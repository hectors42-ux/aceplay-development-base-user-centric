...
export const LevelHeroCard = ({
  ...
  const top = (
    <div className="relative flex-1 bg-gradient-to-br from-skill/10 via-skill/5 to-transparent px-5 pb-4 pt-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex shrink-0 items-start gap-2">
          ...
          {cat && (
            <div
              className="flex flex-col items-center gap-0.5 rounded-2xl bg-skill/15 px-3 py-2"
              aria-label={`Categoría ${cat}`}
            >
              <span className="font-display text-base font-bold leading-none text-skill text-center">
                {cat}
              </span>
      ...
      {/* Posiciones: ranking + Escalerilla */}
      {showPositions && (
