...
BEGIN
  ...
  -- Streak: cuenta cuántos eventos consecutivos (desde el más reciente) son del mismo tipo
  ...
  -- Partidos recientes con normalización de oponente por origen
  ...
  -- Enriquecer con nombre/avatar del oponente
